...
### 입력 
 ...
 <p>Sisendi esimesel real on roboti praeguseks tehtud sammude arv $N$ ($1 \le N \le 1\,000$). Teisel real on $N$ tähemärki, mis näitavad seda, mis suunas iga roboti samm oli: <code>N</code> tähendab sammu põhja, <code>E</code> ida, <code>S</code> lõuna ja <code>W</code> lääne suunas.</p>
